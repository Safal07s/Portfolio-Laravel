                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <table class="table datatable">
                                <a class="btn btn-primary btn-sm " href="{{route('files.create')}}" role="button">Add Files </a>
                                ...
                                <tbody>
                                    @foreach ($files as $file)
                                        <tr>
                                            ...
                                            <td><img src="{{ asset('uploads/' . $file->img) }}" alt=""
                                                    width="100" height="100"></td>
                                            <td>
                                                <a class="btn btn-primary btn-sm " href="{{ route('files.edit',$file->id) }}"
                                                    role="button">Edit </a>
                                                <a class="btn btn-primary btn-sm " href="{{ route('files.show',$file->id) }}"
                                                    role="button">View </a>
